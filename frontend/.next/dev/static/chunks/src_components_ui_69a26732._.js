...
const Hero = ()=>{
    ...
    async function fetchAllJobcount() {
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`142765051_29_4_29_48_11`, "Error fetching jobs:", error));
        } finally{
            setLoading(false);
        }
        setLoading(false);
    ...
    async function fetchAllCompanyCount() {
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`142765051_43_4_43_48_11`, "Error fetching jobs:", error));
        } finally{
            setLoading(false);
        }
        setLoading(false);
    ...
    async function fetchAllUserCount() {
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`142765051_58_4_58_48_11`, "Error fetching jobs:", error));
        } finally{
            setLoading(false);
        }
        setLoading(false);
...
const CarrerGuide = ()=>{
    ...
    const getcarrerguide = async ()=>{
        if (skills.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please add at least one skill");
            return;
        }
        setLoading(true);
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AppContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils_service"]}/api/utils/carrer`, {
                skills: skills
            });
            setResponse(data);
            setResult(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Carrer guidence generated");
        } catch (error) {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-8e7d95e4701aac9" + " " + "flex justify-center",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            onClick: handleOpen,
...
const ResumeAnalyzer = ()=>{
    ...
    const analyzeResume = async ()=>{
        ...
        try {
            ...
            if (!data) {
                /* eslint-disable */ console.error(...oo_tx(`1650034118_80_2_80_46_11`, "Invalid API response:", data));
            ...
            /* eslint-disable */ console.log(...oo_oo(`1650034118_84_0_84_63_4`, "Raw API response:", JSON.stringify(data, null, 2)));
            setResponse(data);
            ...
            /* eslint-disable */ console.log(...oo_oo(`1650034118_89_0_89_29_4`, error.config.url));
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=src_components_ui_69a26732._.js.map