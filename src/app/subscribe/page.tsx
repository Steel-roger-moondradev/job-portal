"use client";
import useRazorpay from "@/components/ui/scriptloader";
...
const SubscriptionPage = () => {
  ...
  const handleSubscribe = async () => {
    ...
    const options = {
      key: "rzp_test_SbNHGCnoc7u5IU", // Replace with your Razorpay key_id
      amount: order.amount, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
      currency: "INR",
      name: "Work Sphere",
      description: "Network and grow with Work Sphere Premium",
      order_id: order.id, 
